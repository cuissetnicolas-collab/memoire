...
compte_reprise = "781000000"  # compte reprise
...
if fichier_entree is not None:
    ...
    for _, r in df.iterrows():
        ...
        # ===========================
        # Reprise de provision 6 mois plus tard
        date_reprise = date_ecriture + relativedelta(months=6)
        # Ajustement dernier jour du mois si nécessaire
        last_day = calendar.monthrange(date_reprise.year, date_reprise.month)[1]
        date_reprise = date_reprise.replace(day=min(date_reprise.day, last_day))
